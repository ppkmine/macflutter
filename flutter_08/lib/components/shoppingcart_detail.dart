...
import 'package:flutter_08/constants.dart';
 ...
 Widget _buildDetailNameAndPrice() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text('Urban Soft AL 10.0', style: TextStyle(
            fontSize: 18, fontWeight: FontWeight.bold,
          ),),
          Text('\$699', style: TextStyle(fontSize: 18,
      ...
      child: Stack(
        children: [
          ...
          Positioned(
              ...
              child: ClipOval(
                child: Container(
                  color: mColor, width: 40, height: 40,
                ),
              ))
